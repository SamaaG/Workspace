...
import edu.umkc.tetrisama.BoardPanel;
import edu.umkc.tetrisama.Clock;
import edu.umkc.tetrisama.SidePanel;
import edu.umkc.tetrisama.Tetris;
import edu.umkc.tetrisama.TileType;



public class TetrisImp implements ITetrisImp extends JFrame 
{
