package edu.umkc.smt.lab5.handlers;
...
import edu.umkc.smt.lab5.IGreeter;//Change to fit your own.
...
public class SampleHandler extends AbstractHandler {
  ...
  private String evaluateGreeterExtension() {
		...
		IConfigurationElement[] config = Platform.getExtensionRegistry()
				.getConfigurationElementsFor("edu.umkc.smt.lab5.helloworld");//Change to fit your own
		try {
