...
import edu.umkc.smt.tetrisplugin.clock.ClockImp;
...
public class TetrisImp extends JFrame implements ITetrisImp {
	...
	public void init() {
		...
		addKeyListener(new KeyAdapter() {
			...
			public void keyPressed(KeyEvent e) {
				...
				/*
				 * Rotate Anticlockwise - When pressed, check to see that the
				 * game is not paused and then attempt to rotate the piece
				 * anticlockwise. Because of the size and complexity of the
				 * rotation code, as well as it's similarity to clockwise
				 * rotation, the code for rotating the piece is handled in
				 * another method.
				 */
				case KeyEvent.VK_Q:
					if (!isPaused) {
				...
				/*
				 * Rotate Clockwise - When pressed, check to see that the game
				 * is not paused and then attempt to rotate the piece clockwise.
				 * Because of the size and complexity of the rotation code, as
				 * well as it's similarity to anticlockwise rotation, the code
				 * for rotating the piece is handled in another method.
				 */
				case KeyEvent.VK_E:
					if (!isPaused) {
	...
	private void rotatePiece(int newRotation) {
		 ...
		 * store a temporary row and column in case we need to move the tile as
		 * well.
		 */
	...
	@Override
	public void begin() {
		logicTimer = _arch.OUT_IClock;	
		// TODO Auto-generated method stub
		//TetrisArch tetris = new TetrisArch();
		startGame();
