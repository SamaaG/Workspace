...
import edu.umkc.smt.tetris1.BoardPanel;
import edu.umkc.smt.tetris1.Clock;
import edu.umkc.smt.tetris1.SidePanel;
...
//		tetris.startGame();
		 ...
		 */
		this.board = new BoardPanel(_arch);
		this.side = new SidePanel(_arch);
